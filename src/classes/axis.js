...
class Axis {
    // Choices
    _DIRECTION_CHOICES = ['left', 'right', 'bidirectional']
    ...
    _width = this._WIDTH
    _arrowHeight = this._ARROW_HEIGHT
    _tickHeight = this._TICK_HEIGHT
    _color = this._COLOR
    // Setter
    _labelBlock = this._LABEL_BLOCK
    ...
    set direction(value) {
        ...
        console.assert(
            typeof(value) == 'string',
            `Incorrect type '${typeof(value)}' of 'Axis.direction'. Must be a string.`
        )

        console.assert(
            _.includes(this._DIRECTION_CHOICES, _.toLower(value)),
            `Incorrect value '${value}' of the 'Axis.direction'. Must be a one of 'right', ` +
            `'left', or 'bidirectional'.`
        )
    ...
    set label(value) {
        ...
        console.assert(
            typeof(value) == 'object',
            `Incorrect type '${typeof(value)}' of 'Axis.label'. Must be an 'object' or 'null'.`
        )
        console.assert(
            typeof(value.format) == 'string',
            `Incorrect type '${typeof(value.format)}' of 'Axis.label.format'. Must be a 'string'.`
        )
        console.assert(
            typeof(value.text) == 'string',
            `Incorrect type '${typeof(value.text)}' of 'Axis.label.text'. Must be a 'string'.`
        )

        console.assert(
            _.includes(this._MJ_FORMATS_CHOICES, value.format),
            `Incorrect value '${value.format}' of the 'Axis.label.format'. ` +
    ...
    set width(value) {
        ...
        console.assert(
            typeof(value) == 'number',
            `Incorrect type '${typeof(value)}' of the 'Axis.width'. Must be a 'number'.`
        )
    ...
    set position(value) {
        ...
        console.assert(
            typeof(value) == 'object',
            `Incorrect type '${typeof(value)}' of the 'Axis.position'. Must be an 'object'.`
        )
        console.assert(
            typeof(value.left) == 'number',
            `Incorrect type '${typeof(value.left)}' of the 'Axis.position.left'. ` +
            `Must be a 'number'.`
        )
        console.assert(
            typeof(value.right) == 'number',
            `Incorrect type '${typeof(value.right)}' of the 'Axis.position.right'. ` +
            `Must be a 'number'.`
        )
    ...
    set margin(value) {
        ...
        console.assert(
            typeof(value) == 'number',
            `Incorrect type '${typeof(value)}' of the 'Axis.margin'. Must be a 'number'.`
        )
    ...
    set arrowHeight(value) {
        ...
        console.assert(
            typeof(value) == 'number',
            `Incorrect type '${typeof(value)}' of the 'Axis.arrowHeight'. Must be a 'number'.`
        )
        console.assert(
            value >= 0,
            `Incorrect value '${value}' of the 'Axis.arrowHeight'. Must be more or equals to 0.`
        )
    ...
    set tickHeight(value) {
        ...
        console.assert(
            typeof(value) == 'number',
            `Incorrect type '${typeof(value)}' of the 'Axis.tickHeight'. Must be a 'number'.`
        )
        console.assert(
            value >= 0,
            `Incorrect value '${value}' of the 'Axis.tickHeight'. Must be more or equals to 0.`
        )
    ...
    set color(value) {
        ...
        console.assert(
            typeof(value) == 'string',
            `Incorrect type '${typeof(value)}' of the 'Axis.color'. Must be a 'string'.`
        )
    ...
    set labelBlock(value) {
        ...
        console.assert(
            ...
            `Incorrect type '${typeof(value)}' of 'Axis.labelBlock'. Must be a 'Block'.`
        )
