...
let { SVG } = require('@svgdotjs/svg.js')
// project modules
...
class Block {
    ...
    // Constructor
    _formulaText = this._FORMULA_TEXT
    _mjAPI = this._MJ_API
    ...
    async createBlock() {
        ...
        this.svg
            .size(
                utils.exToPx(width, this.mjTypeset.ex) * 2,
                utils.exToPx(height, this.mjTypeset.ex) * 2
            )

        // Set formula wrapper
        this.formulaWrapperSVG = this.svg.rect()
        this.formulaWrapperSVG
            .size('100%', '100%')
            .stroke({width: this.wrapper.strokeWidth, color: this.wrapper.strokeColor})
            .fill(
                {
    ...
    centerFormula() {
        ...
        this.formulaSVG
            .move(
                (
                    this.svg.width() - utils.exToPx(this.formulaSVG.width(), this.mjTypeset.ex)
                ) / 2 - 2,
                (
                    this.svg.height() - utils.exToPx(this.formulaSVG.height(), this.mjTypeset.ex)
                ) / 2 - 2
            )
    }
    ...
    set svg(value) {
        console.assert(
            ...
            `Incorrect type '${value}' of 'Block.svg'. Must be a 'SVG' or 'object'.`
        )
    ...
    set formulaSVG(value) {
        console.assert(
            value instanceof Object,
            `Incorrect type '${value}' of 'Block.formulaSVG'. Must be a 'SVG' or 'object'.`
        )
    ...
    set formulaWrapperSVG(value) {
        console.assert(
            value instanceof Object,
            `Incorrect type '${value}' of 'Block.formulaWrapperSVG'. Must be a 'SVG' or 'object'.`
        )
    ...
    set formulaText(value) {
        ...
        console.assert(
            typeof(value) == 'string',
            `Incorrect type '${typeof(value)}' of 'Block.formulaText'. Must be a 'string'.`
        )
    ...
    set mjAPI(value) {
        ...
        console.assert(
            typeof(value) == 'object',
            `Incorrect type '${value}' of 'Block.mjAPI'. Must be an 'object'.`
        )
    ...
    set mjTypeset(value) {
        ...
        console.assert(
            typeof(value) == 'object',
            `Incorrect type '${value}' of 'Block.mjTypeset'. Must be an 'object'.`
        )
    ...
    set format(value) {
        ...
        console.assert(
            typeof(value) == 'string',
            `Incorrect type '${typeof(value)}' of 'Block.format'. Must be a 'string'.`
        )
        console.assert(
            _.includes(this._MJ_FORMATS_CHOICES, value),
            `Incorrect value '${value}' of the 'Block.format'. ` +
    ...
    set wrapper(value) {
        ...
        console.assert(
            typeof(value) == 'object',
            `Incorrect type '${typeof(value)}' of 'Block.wrapper'. Must be an 'object'.`
        )
        console.assert(
            typeof(value.backgroundColor) == 'string',
            `Incorrect type '${typeof(value.backgroundColor)}' of ` +
            `'Block.wrapper.backgroundColor'. Must be a 'string'.`
        )
        console.assert(
            typeof(value.strokeWidth) == 'number',
            `Incorrect type '${typeof(value.strokeWidth)}' of 'Block.wrapper.strokeWidth'. ` +
            `Must be a 'number'.`
        )
        console.assert(
            typeof(value.strokeColor) == 'string',
            `Incorrect type '${typeof(value.strokeColor)}' of 'Block.wrapper.strokeColor'. ` +
            `Must be a 'string'.`
        )
        console.assert(
            typeof(value.backgroundOpacity) == 'number',
            `Incorrect type '${typeof(value.backgroundOpacity)}' of ` +
            `'Block.wrapper.backgroundOpacity'. Must be a 'number'.`
        )
        console.assert(
            typeof(value.width) == 'number' || value.width == undefined,
            `Incorrect type '${typeof(value.width)}' of ` +
            `'Block.wrapper.width'. Must be a 'number' or 'undefined'.`
        )
        console.assert(
            typeof(value.height) == 'number' || value.height == undefined,
            `Incorrect type '${typeof(value.height)}' of ` +
            `'Block.wrapper.height'. Must be a 'number' or 'undefined'.`
        )
