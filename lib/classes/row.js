...
class Row {
  ...
  constructor({
    ...
    _defineProperty(this, "_HEIGHT_CHOICES", ['maxAll', 'maxRow']);
    ...
    _defineProperty(this, "_HEIGHT", 'maxAll');

    _defineProperty(this, "_JOIN", {
      in: false,
      out: false
    });
    ...
    _defineProperty(this, "_content", this._CONTENT);

    _defineProperty(this, "_type", this._TYPE);

    _defineProperty(this, "_height", this._HEIGHT);

    _defineProperty(this, "_join", this._JOIN);

    _defineProperty(this, "_block", null);
  ...
  set n(value) {
    ...
    console.assert(typeof value == 'number' || value instanceof Array, `Incorrect type '${typeof value}' of 'Row.n'. Must be a 'number' or 'Array'.`);
    this._n = value;
  }
  ...
  set content(value) {
    ...
    console.assert(typeof value == 'object', `Incorrect type '${typeof value}' of 'Row.content'. Must be an 'object' or 'null'.`);
    console.assert(typeof value.format == 'string', `Incorrect type '${typeof value.format}' of 'Row.content.format'. Must be a 'string'.`);
    console.assert(typeof value.text == 'string', `Incorrect type '${typeof value.text}' of 'Row.content.text'. Must be a 'string'.`);
    console.assert(_.includes(this._MJ_FORMATS_CHOICES, value.format), `Incorrect value '${value.format}' of the 'Row.content.format'. Must be ` + `a one of 'inline-TeX', 'TeX', 'AsciiMath', or 'MathML'.`);
    this._content = value;
  }
  ...
  set type(value) {
    ...
    console.assert(typeof value == 'object', `Incorrect type '${typeof value}' of 'Row.type'. Must be an 'object'.`);
    this._type = value;
  }
  ...
  set height(value) {
    ...
    console.assert(typeof value == 'string', `Incorrect type '${typeof value}' of 'Row.height'. Must be a 'string'.`);
    console.assert(_.includes(this._HEIGHT_CHOICES, value), `Incorrect value '${value}' of the 'Row.height'. Must be a one of 'maxAll', ` + `or 'maxRow'.`);
    this._height = value;
  }
  ...
  set join(value) {
    ...
    console.assert(typeof value == 'object', `Incorrect type '${typeof value}' of 'Row.join'. Must be an 'object'.`);
    console.assert(typeof value.in == 'boolean', `Incorrect type '${typeof value.in}' of 'Row.join.in'. Must be a 'boolean'.`);
    console.assert(typeof value.out == 'boolean', `Incorrect type '${typeof value.out}' of 'Row.join.out'. Must be a 'boolean'.`);
    this._join = value;
  }
  ...
  set block(value) {
    console.assert(value instanceof Block, `Incorrect type '${typeof value}' of 'Row.block'. Must be a 'Block'.`);
    this._block = value;
  }
